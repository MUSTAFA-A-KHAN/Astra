...
const runtimeFiles = ['forest-loner-diorama/forest-loner-diorama.glb', 'plaza-night-time/plaza-night.glb', 'plaza-night-time/plaza-night-footprint.glb', 'plaza-night-time/plaza-navigation.json', 'map-79-void/skibidi-toilet-79.glb', 'map/a_forest_3_with_a_road_at_night_for_game.glb', 'map/worldmachine_terrain.glb'];
